...
"""Column Transformator and Onehot Encoder"""
...
eclf1 = VotingClassifier(estimators=[('XGB', clf1), ('KNN', clf2), ('RF', clf3)], voting='soft')
...
pickle.dump(eclf1, open('train-stokes.pkl', 'wb'))